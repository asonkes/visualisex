...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Projects::class, mappedBy: 'user_id', orphanRemoval: true)]
    ...
    // Pour récupérer l'email de l'utilisateur (méthode : get)
    public function getEmail(): ?string
    {
        return $this->email;
    }

    // Permet de stocker l'email de l'utilisateur (méthode : set)
